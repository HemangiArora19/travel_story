...
const TagInput = ({tags,setTags}) => {
  ...
  <div className="flex item-center gap-2 flex-wrap mt-2">
    {tags.map((tag, index) => (
      <span key={index} className="flex item-center gap-2 text-sm text-cyan-600 bg-cyan-200/40 px-3 py-1 rounded">
        ...
        <div className='flex item-center gap-4 mt-3'>
            ...
            />
            <button className='w-8 h-8 flex items-center justify-center rounded border border-cyan-500' onClick={addNewTag}>
