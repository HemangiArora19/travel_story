...
const TravelStoryCard = ({
    ...
    {
        // Log the props data to the console
...
>
  <FaHeart
    className={`icon-btn ${isFavourite ? 'text-red-500' : 'text-gray-400'}`}
  />
</button>
        ...
        <div className='p-4' onClick={onClick}>
            <div className='flex items-center gap-3'>
              <div className='flex-1'>
                ...
                <span className="text-xs font-slate-500">
  {date ? moment(date).format("Do MMM YYYY") : "-"}
            ...
            <div className='inline-flex item-center gap-2 text-[13px] text-cyan-600 bg-cyan-200/40 rounded mt-3 px-2 py-1 '>
